...
//        con.conectar();
//        Object[][] dtCli;        
//        String[] columNames = {"id_cliente", "nombre", "apellido_P", "apellido_M", "telefono", "TIF", "Email", "colonia", "calle", "no", "fecha", "hora"};  
//        // se utiliza la funcion
//        dtCli = u.getDatos();
//        // se colocan los datos en la tabla
//        DefaultTableModel datos = new DefaultTableModel(dtCli,columNames);                        
...
String[] columNames = {"id_cliente", "nombre", "apellido_P", "apellido_M", "telefono", 
            "TIF", "Email", "colonia", "calle", "no", "fecha", "hora"};  
// se utiliza la funcion
dtEdi = u.getDatos();
// se colocan los datos en la tabla
...
break;
    ...
    private void initComponents() {
        ...
        Buscar.setFont(new java.awt.Font("Yu Gothic", 1, 14)); // NOI18N
        ...
        BtnNuevo.getAccessibleContext().setAccessibleParent(TablaCliente);
...
//System.out.println(codigo);
        u.ActualizarCliente(Campo1, Campo2, Campo3, Campo4, Campo5, Campo6,Campo7,Campo8,Campo9,Campo10,Campo11,Campo12);
...
//         if (fila > -1){                          
//        // Automovil.Jcodigo.setText(String.valueOf(TablaCliente.getValueAt(fila, 0)));
//         Automovil.txtDueño.setText(String.valueOf(TablaCliente.getValueAt(fila, 1)));
//         }
     Automovil.txtDueño.setText(TxtNombre.getText());
...
//this.dispose();
 ...
 fila = TablaCliente.rowAtPoint(evt.getPoint());                 
         if (fila > -1){      
             Jcodigo.setText(String.valueOf(TablaCliente.getValueAt(fila, 0)));
             ...
             //TxtFecha.setText(String.valueOf(TablaCliente.getValueAt(fila, 10)));
             //TxtHora.setText(String.valueOf(TablaCliente.getValueAt(fila, 11)));
